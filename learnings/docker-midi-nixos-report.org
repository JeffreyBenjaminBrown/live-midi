...
Your rig has ~alsaSeq.enable = false~, which disables the ALSA sequencer. This means:
...
- If you need ALSA sequencer support, consider enabling it in your NixOS rig, or run ~a2jmidid~ on the host to bridge ALSA MIDI to JACK
