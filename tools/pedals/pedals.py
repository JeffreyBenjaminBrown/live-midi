...
so there's no ambiguity.
  ...
  python3 tools/pedals/pedals.py --list     # list candidate MIDI-in ports and exit
  python3 tools/pedals/pedals.py --port hw:2,0,0   # force a specific rawmidi port
  python3 tools/pedals/pedals.py 8          # run ~8s then exit (for testing)
