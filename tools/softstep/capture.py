...
(even on Ctrl-C / crash). No firmware is touched.
  ...
  python3 tools/softstep/capture.py            # all phases A, B, C
  python3 tools/softstep/capture.py A           # just one/some phases
  python3 tools/softstep/capture.py A B
...
Output: tools/softstep/captures/session-<timestamp>.log
