...
with two boards, hence this compact view.)
  ...
  python3 tools/softstep/meter/main.py          # run until 'q' or Ctrl-C
  python3 tools/softstep/meter/main.py 5         # run ~5s then exit (for testing)
...
CONFIG: tools/softstep/meter/config.toml -- all tunables, hot-reloadable.
...
REPO_ROOT = os.path.abspath(os.path.join(HERE, "..", "..", ".."))  # meter/ -> repo root (tools/softstep/meter/)
