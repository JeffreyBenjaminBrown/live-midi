...
use crate::layout::{map_rect, monome_windows, undo_cell, WindowId};
use crate::remap::preimage_for_step;
...
pub(crate) fn render_led_levels(
  ...
  for y in rect.y0..rect.y1 {
    for x in rect.x0..rect.x1 {
      ...
      let step = crate::layout::grid_step(&state.config, x - rect.x0, y - rect.y0);
